(async () => {
  ...
  const TEXTS = {
    ...
    id: {
      ...
      colorsFound: "✅ {count} warna tersedia ditemukan",
      loadingImage: "🖼️ Memuat gambar...",
      imageLoaded: "✅ Gambar dimuat dengan {count} piksel valid",
      imageError: "❌ Gagal memuat gambar",
      selectPositionAlert: "Warnai piksel pertama di lokasi tempat Anda ingin gambar dimulai!",
      waitingPosition: "👆 Menunggu Anda mewarnai piksel referensi...",
      positionSet: "✅ Posisi berhasil diatur!",
      positionTimeout: "❌ Waktu untuk memilih posisi habis",
      startPaintingMsg: "🎨 Mulai menggambar...",
      paintingProgress: "🧱 Progres: {painted}/{total} piksel...",
      noCharges: "⌛ Tidak ada kesempatan. Menunggu {time}...",
      paintingStopped: "⏹️ Menggambar dihentikan oleh pengguna",
      paintingComplete: "✅ Menggambar selesai! {count} piksel diwarnai.",
      ...
      initMessage: "Klik 'Mulai Auto-BOT' untuk memulai",
      waitingInit: "Menunggu inisialisasi...",
      resizeSuccess: "✅ Ukuran gambar diubah menjadi {width}x{height}",
      paintingPaused: "⏸️ Menggambar dijeda pada posisi X: {x}, Y: {y}",
    },
  };
