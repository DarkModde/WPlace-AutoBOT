(async () => {
  ...
  const TEXTS = {
    ...
    de: {
      ...
      selectPositionAlert: "Male das erste Pixel an der Stelle, an der das Bild beginnen soll!",
      waitingPosition: "👆 Warte, bis das Referenzpixel gemalt wurde...",
      positionSet: "✅ Positionierung erfolgreich gesetzt!",
      positionTimeout: "❌ Zeitüberschreitung für Positionsauswahl",
      startPaintingMsg: "🎨 Beginne mit dem Malen...",
      paintingProgress: "🧱 Fortschritt: {gemalt}/{total} Pixel...",
      noCharges: "⌛ Keine Gebühren. Warte {time}...",
      ...
      initMessage: "Klicke auf 'Auto-BOT starten', um zu beginnen",
      waitingInit: "Warten auf Initialisierung...",
      resizeSuccess: "✅ Bildgröße angepasst auf {Breite} x {Höhe}",
      paintingPaused: "⏸️ Malen an Position X: {x}, Y: {y} angehalten"
    }
  };
