(async () => {
  ...
  const TEXTS = {
    ...
    uk: {
      ...
      noColorsFound: "❌ 打开网站上的调色板并重试！",
      colorsFound: "✅ 找到 {count} 种可用颜色",
      loadingImage: "🖼️ 加载图像...",
      imageLoaded: "✅ 图像加载成功，包含 {count} 个有效像素",
      imageError: "❌ 加载图像时出错",
      selectPositionAlert: "在您希望艺术作品开始的地方绘制第一个像素！",
      waitingPosition: "👆 等待您绘制参考像素...",
      positionSet: "✅ 成功设置位置！",
      positionTimeout: "❌ 选择位置超时",
      startPaintingMsg: "🎨 开始绘画...",
      paintingProgress: "🧱 进度: {painted}/{total} 像素...",
      noCharges: "⌛ 没有点数。等待 {time}...",
      paintingStopped: "⏹️ 用户停止了绘画",
      paintingComplete: "✅ 绘画完成！{count} 像素已绘制。",
      paintingError: "❌ 绘画过程中出错",
      missingRequirements: "❌ 请先加载图像并选择位置",
      progress: "进度",
      pixels: "像素",
      charges: "点数",
      estimatedTime: "预计时间",
      initMessage: "点击 '启动自动机器人' 开始",
      waitingInit: "等待初始化...",
      resizeSuccess: "✅ 图像已调整为 {width}x{height}",
      paintingPaused: "⏸️ 绘画已暂停，位置 X: {x}, Y: {y}"
    }
  };
